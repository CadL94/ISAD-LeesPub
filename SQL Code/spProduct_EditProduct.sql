...
@ProductID int, @CategoryID int, @ProductName NVARCHAR(50), @ProductDescription NVARCHAR(30), @QuantityPerUnit NVARCHAR(30), @Price SMALLMONEY, @UnitsInStock SMALLINT, @RestockLevel SMALLINT, @Avaliable BIT
AS 
BEGIN
    UPDATE  dbo.Product 
    SET
